...
from agent_actor_critic_vec import SACAgent
...
def train_loop(
    ...
    """Custom training loop for vectorized SACAgent."""
    ...
    for step in range(max_env_steps):
        ...
        if frame_count >= last_log_frame + 1000:
            ...
            tensorboard_writer.add_scalar("train/value_loss", mean_value_loss, frame_count)
            tensorboard_writer.add_scalar("train/total_loss", mean_total_loss, frame_count)
