...
def create_single_atari_env(
    ...
    if video_path:
        print(f"[Video] Recording videos every {video_freq_episodes} episodes to {video_path}")
        env = RecordVideo(
...
def train_agent(
    ...
    Args:
        ...
        video_freq_episodes: Record video every N episodes
    ...
    env = create_single_atari_env(
        ...
        video_freq_episodes=video_freq_episodes,
    )
...
def main():
    ...
    agent, model_path = train_agent(
        ...
        video_freq_episodes=args.video_freq,
